...
namespace RobotMax
{
    ...
    public class Conductor
    {
        ...
        static public String[] singleValueOptions = { "", "Expression Afraid", "Expression Awkward", "Expression Angry", "Expression Disappointed", "Expression Happy", "Expression Neutral", "Expression Sad", "Expression Sinister", "Expression Sleepy", "Expression Smile", "Expression Sneaky", "Expression Sulk", "Expression Surprised", "Expression Yelling", "Expression Worried", "Eyebrows Slight Pinch", "Eyebrows Pinch", "Eyebrows Level", "Eyebrows Slight Spread", "Eyebrows Spread", "Eyebrow Left Pinch", "Eyebrow Left Spread", "Eyebrow Right Pinch", "Eyebrow Right Spread", "Eyes Center", "Eyes Slight Left", "Eyes Half Left", "Eyes Left", "Eyes Slight Right", "Eyes Half Right", "Eyes Right", "Eyes Slight Up", "Eyes Up", "Eyes Half Up", "Eyes Slight Down", "Eyes Half Down", "Eyes Down", "Eyes Roll", "Eyes Pinch", "Eyes Spread", "Eyelids Blink", "Eyelid Left Blink", "Eyelid Right Blink", "Eyelids Open", "Eyelids Half", "Eyelids Close", "Lips Smile", "Lips Level", "Lips Frown", "Lips Left Diagonal", "Lips Right Diagonal", "Jaw Slight Open", "Jaw Open", "Jaw Half", "Jaw Slight Close", "Jaw Close", "Neck Slight Left", "Neck Left", "Neck Half Left", "Neck Front", "Neck Slight Right", "Neck Half Right", "Neck Right", "Neck Slight Up", "Neck Half Up", "Neck Up", "Neck Front", "Neck Slight Down", "Neck Half Down", "Neck Down", "Neck Yes", "Neck No", "Say 'Hello'", "Say 'Goodbye'", "Say 'How are you'", "Say 'My name is RobotMax'", "Say 'What is your name?'", "Say 'I am a robot'", "Say 'Are you human?'" };
 ...
 */ 
        ...
        #region Comando dos botões no Form PLAY, STOP, RESTART, RESET, PAUSE, COPY, DELETE, CUT, 
        ...
        {
            if (recorder.InsertAmpMouthMovements())
            {
                CalculateTriggers(ref robotStates, recorder.getOneSecondRange());
            }
            else
            {
                MessageBox.Show("No audio present to create mouth movements on!");
            }
        }
        ...
        public void Set(string name, bool val)
        {
            ...
            if (name.Equals("Eyes Half Left"))
            {
              if (val)
                SetEyesHorizontal(0.25f);
              else
                SetEyesHorizontal(0.5f);
            }
            else
            ...
            if (name.Equals("Eyes Half Right"))
            {
              if (val)
                SetEyesHorizontal(0.75f);
              else
                SetEyesHorizontal(0.5f);
            }
            else
            ...
            if (name.Equals("Eyes Half Up"))
            {
              if (val)
                SetEyesVertical(0.25f);
              else
                SetEyesVertical(0.5f);
            }
            else
            ...
            if (name.Equals("Eyes Half Down"))
            {
              if (val)
                SetEyesVertical(0.75f);
              else
                SetEyesVertical(0.5f);
            }
            else
            ...
            if (name.Equals("Neck Half Right"))
            {
              if (val)
                SetNeckTwist(0.75f);
              else
        ...
        #region Funções de Cada Membro (int pin, int val, int min, int max, bool isCenter)
        ...
        #region Funções de Cada Membro (Float Val)
        ...
        const int OBJECT_LEFT_EYEBROW = 0;
        const int OBJECT_RIGHT_EYEBROW = 1;
        const int OBJECT_LEFT_EYELID = 2;
        const int OBJECT_RIGHT_EYELID = 3;
        const int OBJECT_LEFT_HORIZONTAL_EYE = 4;
        const int OBJECT_RIGHT_HORIZONTAL_EYE = 5;
        const int OBJECT_LEFT_VERTICAL_EYE = 6;
        const int OBJECT_RIGHT_VERTICAL_EYE = 7;
        const int OBJECT_TWIST_NECK = 8;
        const int OBJECT_TILT_NECK = 9;
        const int OBJECT_LEFT_LIP = 10;
        const int OBJECT_RIGHT_LIP = 11;
        const int OBJECT_JAW = 12;
        const int OBJECT_DELAY = 255;
        public const int MAX_SEQ_BYTES = 850;
        ...
        public List<int> Upload()
        {
            ...
            for (i = 0; i < robotStates.Count; i++)
            {
                RobotState next = robotStates[i];

                bool delayAdded = false;

                if (next.rightEyebrow != -1)
                {
                    if (curr.rightEyebrow != next.rightEyebrow)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                            data.Add((int)(((next.position - curr.position) / 100) * 25) / 16);
                            delayAdded = true;
                        }

                        data.Add(OBJECT_RIGHT_EYEBROW);
                        data.Add((int)((1.0f - next.rightEyebrow) * 2000.0f) - 1000);
                    }
                }

                if (next.leftEyebrow != -1)
                {
                    if (curr.leftEyebrow != next.leftEyebrow)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_LEFT_EYEBROW);
                        data.Add((int)(next.leftEyebrow * 2000.0f) - 1000);
                    }
                }

                if (next.rightHorizontalEye != -1)
                {
                    if (curr.rightHorizontalEye != next.rightHorizontalEye)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_RIGHT_HORIZONTAL_EYE);
                        data.Add((int)(next.rightHorizontalEye * 2000.0f) - 1000);
                    }
                }

                if (next.leftHorizontalEye != -1)
                {
                    if (curr.leftHorizontalEye != next.leftHorizontalEye)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_LEFT_HORIZONTAL_EYE);
                        data.Add((int)(next.leftHorizontalEye * 2000.0f) - 1000);
                    }
                }

                if (next.rightVerticalEye != -1)
                {
                    if (curr.rightVerticalEye != next.rightVerticalEye)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_RIGHT_VERTICAL_EYE);
                        data.Add((int)(next.rightVerticalEye * 2000.0f) - 1000);
                    }
                }

                if (next.leftVerticalEye != -1)
                {
                    if (curr.leftVerticalEye != next.leftVerticalEye)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_LEFT_VERTICAL_EYE);
                        data.Add((int)((1.0f - next.leftVerticalEye) * 2000.0f) - 1000);
                    }
                }

                if (next.rightEyelid != -1)
                {
                    if (curr.rightEyelid != next.rightEyelid)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_RIGHT_EYELID);
                        data.Add((int)((1.0f - next.rightEyelid) * 2000.0f) - 1000);
                    }
                }

                if (next.leftEyelid != -1)
                {
                    if (curr.leftEyelid != next.leftEyelid)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_LEFT_EYELID);
                        data.Add((int)((1.0f - next.leftEyelid) * 2000.0f) - 1000);
                    }
                }

                if (next.neckTilt != -1)
                {
                    if (curr.neckTilt != next.neckTilt)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_TILT_NECK);
                        data.Add((int)((1.0f - next.neckTilt) * 2000.0f) - 1000);
                    }
                }

                if (next.neckTwist != -1)
                {
                    if (curr.neckTwist != next.neckTwist)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_TWIST_NECK);
                        data.Add((int)(next.neckTwist * 2000.0f) - 1000);
                    }
                }

                if (next.leftLip != -1)
                {
                    if (curr.leftLip != next.leftLip)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_LEFT_LIP);
                        data.Add((int)((1.0f - next.leftLip) * 2000.0f) - 1000);
                    }
                }

                if (next.rightLip != -1)
                {
                    if (curr.rightLip != next.rightLip)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_RIGHT_LIP);
                        data.Add((int)((1.0f - next.rightLip) * 2000.0f) - 1000);
                    }
                }

                if (next.jaw != -1)
                {
                    if (curr.jaw != next.jaw)
                    {
                        if (!delayAdded)
                        {
                            data.Add(OBJECT_DELAY);
                        ...
                        data.Add(OBJECT_JAW);
                        data.Add((int)((1.0f - next.jaw) * 2000.0f) - 1000);
                    }
                }
